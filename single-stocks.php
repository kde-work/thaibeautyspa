                ...
                <div class="main enroll">
                    <div class="center">
                        ...
                        if ( !empty( $_GET['param'] ) AND $_GET['param'] == 'main' ) :
                            ...
                            ?>
                            <a href="/спец-предложения/#акции" class="btn btn__back">« АКЦИИ</a>
                            <?php
                        endif;
                        ?>
                        ...
                        <div class="enroll__top">
                            ...
                            <div class="enroll__top__right block--back-image" style="background-image: url('<?php the_field('foto'); ?>');">
                            </div>
                        </div>
                            ...
                            <li>
                                <div class="services__items__block">
                                    <div class="services__item__left--mobile"
                                         style="background-image: url('<?php the_field('foto'); ?>');">
                                    </div>
                                    <div class="services__item__right__text">
                                        <h3 class="slider-up"><?php echo $title; ?></h3>
                                        <hr>
                                        <p class="text--italic"><?php the_field('desc'); ?></p>
                                    ...
                                    <div class="enroll">
                                        <div class="center">
                                            <div class="enroll__bottom">
                                                <div class="enroll__bottom__left">
                                                    <?php if ($time1 AND $cost1) : ?>
                                                        <div class="enroll__bottom__price<?php
add_filter('body_class','services_body_class');
function services_body_class( $classes ) {
	$classes[] = 'services';
	$classes[] = 'single-services';
                                            ...
                                            <div class="enroll__bottom">
                                                ...
                                                <div class="" style="text-align: center;">
                                                    ...
                                                    <?php
                                                        ...
                                                        ?>
                                                        <a href="/спец-предложения/#акции" class="best-service-m__back" title="К выбору">« АКЦИИ</a>
                                                    <?php
                                                    endif;
                                                    ?>
                                                </div>
