                                                ...
                                                <li class="services__reach-slider">
                                                    <div class="services__first">
                                                        ...
                                                        <div class="type_b_mobi_btn" style="text-align: center; margin-bottom: 40px;">
                                                                <button class="btn" style="position: relative!important;"  onclick="popup_c({'cat':'обратный-звонок', 'title':'Написать директору', 'email': 1, 'time': 0, 'gender': 0, 'description': 'Заказ обратного звонка'}, this);">написать директору</button>
                                                ...
                                                <div class="services__first">
                                                    ...
                                                    <div class="services__second">
                                                        ...
                                                        <div class="wrap slider-left">
                                                            <button class="btn btn--zap" onclick="popup_c({'cat':'обратный-звонок', 'title':'Написать директору', 'email': 1, 'time': 0, 'gender': 0, 'description': 'Заказ обратного звонка'}, this);">написать директору</button>
                                                        </div>
