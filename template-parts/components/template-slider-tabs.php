                                        ...
                                        <ul class="slider">
                                            ...
                                            if ( count( $slides ) ) {
                                                foreach ( $slides as $slide ) {
                                                    ?>
                                                    <li class="scroll-box__slide service__slick-li">
                                                        <div class="scroll-box__cont">
                                                            <div class="scrollable--tmp scrollable--100-90">
                                                                ...
                                                                <?php echo $slide->get_field( 'Описание слайда' ); ?>
                                                            </div>
                                                        </div>
                                                        <div class="container__img container__img--not-js-height container__img--desc block--back-image" style="background-image: url('<?php echo $slide->get_img( 'Картинка Большая', 'large' )[0]['src']; ?>');"></div>
                                                    </li>
                                                    <?php
                                                }
                                            }
